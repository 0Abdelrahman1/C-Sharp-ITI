...
namespace NorthWindConsole.Context
{
    ...
    public partial class NorthwindContextProcedures : INorthwindContextProcedures
    {
        ...
        public virtual async Task<int> UpdateProductPriceAsync(decimal? unitPrice, int? productID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[UpdateProductPrice] @UnitPrice = @UnitPrice, @ProductID = @ProductID", sqlParameters, cancellationToken);
