...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            //entity.DeleteUsingStoredProcedure("SoftDeletePrds", B => B.HasParameter("ID"));
            ///Call Soft Delete SP instead of Generated Delete SQL Statments 

            entity.HasQueryFilter(P => P.Discontinued ==  true);
