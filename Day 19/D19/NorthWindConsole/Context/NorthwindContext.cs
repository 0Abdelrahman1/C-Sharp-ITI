...
using NorthWindConsole.Interceptors;
...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        .AddInterceptors(new ProductSofftDeleteInterceptor())
        .UseSqlServer("Data Source=.;Initial Catalog=Northwind;Integrated Security=True;Encrypt=false");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasQueryFilter(P => P.Discontinued == false);
